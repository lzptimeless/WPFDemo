...
namespace WPFDemo.I18n.Resources
{
    public class LanguageManager : ILanguageManager
    {
        ...
        {
            return _langLib.GetTextParts(key, textCase, formatArgs);
        }
        ...
        {
            return _langLib.GetCountTextParts(key, count, textCase, formatArgs);
        }
